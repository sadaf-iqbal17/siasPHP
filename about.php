...
<div class="abt-banner" style="background-image: url(images/img.jpg);">
...
<section class="about">
   ...
   <div class="row" style="margin-top:-5%">
      ...
      <div class="content" style="position:relative;  width:50%; margin-left:20px; color:black">
        <strong> <h1 style="font-size:30px !important">Why choose us?</h1></strong>
      ...
      <div class="image" >
        ...
        <img src="images/vector-2.jpg"style="margin-top:90px; position:relative;display:flex;height:20%">
      </div>
   ...
   <div class="box-container">
      ...
      <div class="box">
         <i class="fas fa-graduation-cap" style="color:var(--oragen);"></i>
         <div>
            <h3>+1k</h3>
      ...
      <div class="box">
         <i class="fas fa-user-graduate" style="color:var(--oragen);"></i>
         <div>
            <h3>+25k</h3>
      ...
      <div class="box">
         <i class="fas fa-chalkboard-user"style="color:var(--oragen);"></i>
         <div>
            <h3>+5k</h3>
      ...
      <div class="box">
         <i class="fas fa-briefcase" style="color:var(--oragen);"></i>
         <div>
            <h3>100%</h3>
...
<section class="reviews">
   ...
   <center><h1 class="heading">student's reviews</h1></center>
